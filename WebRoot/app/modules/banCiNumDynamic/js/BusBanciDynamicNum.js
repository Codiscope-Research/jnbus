	...
	success : function(response) { // 回调函数有1个参数
		...
		Ext.onReady(function() {
			...
			var teamStore = new Ext.data.Store({
				proxy : new Ext.data.HttpProxy({
					url : 'banCiNumDynamic.do?reqCode=queryteamDatasByClass'
				}),
				reader : new Ext.data.JsonReader({}, [{
					name : 'value'
				}, {
			...
			var routeStore = new Ext.data.Store({
				proxy : new Ext.data.HttpProxy({
					url : 'banCiNumDynamic.do?reqCode=queryrouteDatasByClass'
				}),
				reader : new Ext.data.JsonReader({}, [{
					name : 'value'
				}, {
			...
			var qForm = new Ext.form.FormPanel({
				...
				buttons : [{
					...
					handler : function() {
						...
						createGraph( routeCombo.getValue() );
								...
								load: function() {
									...
									if(obj != 0){
										setInterval(function() {
											...
											$.getJSON("banCiNumDynamic.do?reqCode=queryBanciNumDynamic4Route",{
												routeId : obj
